...
def analize():
    ...
    if M['m00'] != 0:
        ...
        if cx < 800:
            cv2.putText(bgr_img, 'Turn left', (40, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 3)
            signal = 'left'
        if cx > 1100:
            cv2.putText(bgr_img, 'Turn right', (40, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 3)
            signal = 'right'
        if (cx > 800) & (cx < 1100):
            cv2.putText(bgr_img, 'Go forward', (40, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3)
            signal = 'forward'

    cv2.line(bgr_img, (800, 0), (800, 1080), (0, 0, 255), 5)
    cv2.line(bgr_img, (1100, 0), (1100, 1080), (0, 0, 255), 5)
